...
{
    /**
     * Used as the default {@link xyz.bluspring.kilt.injections.gametest.framework.GameTestInjection#templateNamespace() template namespace} for any game tests in the class that do not specify one.
     */
