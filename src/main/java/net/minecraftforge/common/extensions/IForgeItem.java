...
public interface IForgeItem extends ItemExtensions, io.github.fabricators_of_create.porting_lib.extensions.tool.ItemExtensions, net.fabricmc.fabric.impl.item.ItemExtensions
{
    private Item self()
    {
        return (Item) this;
